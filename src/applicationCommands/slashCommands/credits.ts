        ...
        let user = interaction.member.user as User,
            ...
            .addFields([
                ...
                { name: "Artist", value: ["**Semblance:** cabiie",
                    ...
                    "**Semblance Revisioned Art:** StarLuckArt(preview soon:tm:) ([DeviantArt](https://www.deviantart.com/starluckart) and [Personal Site](https://bubblestheprotogen.wixsite.com/starluckart))"].toString()
                },
                ...
                { name: "Contributors", value: ["**Mesozoic Valley Guide:** Jojoseis",
                    ...
                    "**Image for Currency:** Off Pringles"].toString()
                }
            ]);
