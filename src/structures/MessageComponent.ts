import { Component, ComponentData, Components } from '@semblance/lib/interfaces/MessageComponent';
...
export class MessageComponent {
    ...
    constructor(data?: ComponentData) {
        ...
        if (Array.isArray(data)) this.addButtons(data); 
        else if (typeof data === 'object') this.addButton(data);
    }

    addButton(component: Component) {
        this.components[0].components.push(MessageComponent.normalizeComponent(component));
        return this;
    }

    addButtons(components: Component[]) {
        ...
        if (!components.every(component => typeof component === 'object')) throw new Error('components array must be all objects');
            components.forEach((component) => {
                    this.components[0].components.push(MessageComponent.normalizeComponent({
                        type: component.type,
    ...
    static normalizeComponent(component: Component) {
