...
module.exports.run = async (client: Semblance, interaction: Interaction) => {
    let choice = interaction.data.options[0].value as string,
    ...
    interaction.send(`Due to your choice being invalid, I'mma just say that my choice, ${sembChoice}, beats whatever the heck ${playerChoice} is.`);
}
