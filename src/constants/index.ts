...
export const customIDRegex = /(?<!.){command:'[a-z]{3,20}',action:'[a-z]{1,15}',id:'\d{17,20}'(,page:'\d{1,3}')?}(?!.)/;
export const properCustomIDRegex = /(?<!.){"command":"[a-z]{3,20}","action":"[a-z]{1,15}","id":"\d{17,20}"(,"page":"\d{1,3}")?}(?!.)/;
