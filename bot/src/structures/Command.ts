import { componentInteractionDefaultParser, type ComponentInteractionDefaultParserOptions } from '#constants/components';
import { getPermissionLevel, type Category, type GuildId, type PreconditionName, type SubCategory } from '#constants/index';
import type { Awaitable, ParsedCustomIdData, ResultValue } from '#lib/typess/Semblance';
import {
...
export abstract class Command {
	...
	public async preRun(
		...
		if (interaction.data.type === ApplicationCommandType.User || interaction.data.type === ApplicationCommandType.Message) {
	 ...
	 * ```
	 */
	public contextMenuRun?(reply: FastifyReply, interaction: APIContextMenuInteraction, options: InteractionOptionResolver): Awaitable<void>;
	 ...
	 * ```
	 */
	public componentRun?(reply: FastifyReply, interaction: APIMessageComponentInteraction, customData: ParsedCustomIdData): Awaitable<unknown>;
	 ...
	 * ```
	 */
	public async componentPreparser(interaction: APIMessageComponentInteraction): Promise<ResultValue<boolean, ParsedCustomIdData>> {
