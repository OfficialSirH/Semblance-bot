        ...
        .addFields([
            {
                ...
                value: [`When starting a new stage get to your newest dinos as fast as possible completely ignoring all the dinos before the newest 3-4. Then only upgrade these few as far as you can afford in the first 10-15 min.`, 
            ...
            {
                name: '**Missions**',
                value: [`Always try to do all the missions before calling the asteroid to get to the next stage.`,
