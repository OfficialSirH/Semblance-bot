 ...
 * const { Webhook } = require(`./structures/@discord-boats/sdk`)
 *
 * const app = express()
 ...
 * app.listen(80)
 *
 * // In this situation, your discord.boats Webhook dashboard should look like
 * // URL = http://your.server.ip:80/dboatswebhook
...
export declare class Webhook {
     ...
     * @example
     * app.post('/dboatswebhook', wh.middleware(), (req, res) => {
